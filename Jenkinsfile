    ...
    stages {
        ...
        stage('Install Missing Dependencies') {
            steps {
                ...
                script {
                    bat '''
                    mvn install:install-file -Dfile=libs\gpsutil-1.0.jar -DgroupId=com.gpsutil -DartifactId=gpsutil -Dversion=1.0 -Dpackaging=jar
                    mvn install:install-file -Dfile=libs\trippricer-1.0.jar -DgroupId=com.trippricer -DartifactId=trippricer -Dversion=1.0 -Dpackaging=jar
                    mvn install:install-file -Dfile=libs\rewardcentral-1.0.jar -DgroupId=com.rewardcentral -DartifactId=rewardcentral -Dversion=1.0 -Dpackaging=jar
                    '''
                }
            }
        }
